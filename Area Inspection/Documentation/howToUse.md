...
1. Select ![App settings to customize experience.](media/inspection/teams-settings.png?raw=true "App settings to customize experience") from the upper-right corner.
...
1. Select **Save** to save the changes to label setup.
    ...
    ![Customize experience.](media/inspection/customize-experience.png?raw=true "Customize experience")
...
1. Configure or skip Planner integration:
    ...
    ![Planner integration.](media/inspection/planner-tab.png?raw=true "Planner integration")
...
1. If available, select the *Tasks* (Planner) instance to integrate the app with Planner.
    ...
    ![Select Team, Channel and Planner.](media/inspection/select-planner-channel.png?raw=true "Select channel and Planner")

1. Select **Continue**.

1. Select **Let's go**.

    ![Integrate with channel and planner.](media/inspection/channel-planner-integrate.png?raw=true "Integrate with channel and planner")
...
1. Select ![Teams settings for managing inspections.](media/inspection/teams-settings.png?raw=true "Teams settings for managing inspections") from the upper-right corner.
...
1. Select **Save**.
    ...
    ![Edit app configuration.](media/inspection/edit-app-configuration.png?raw=true "Edit app configuration")
...
1. Select ![Teams settings for locations.](media/inspection/teams-settings.png?raw=true "Teams settings for locations") from the upper-right corner.
...
1. Select **Save**.
    ...
    ![Add location type.](media/inspection/add-location-type.png?raw=true "Add location type")
...
1. Select **Save**.
    ...
    ![Add location.](media/inspection/add-location.png?raw=true "Add location")
...
1. Select **Save**.
    ...
    ![Add inspection form.](media/inspection/add-inspection-form.png?raw=true "Add inspection form")
...
1. In the **Inspections** section, select a submitted inspection.
    ...
    ![Select submitted inspection.](media/inspection/select-submitted-inspection.png?raw=true "Select submitted inspection")

1. Review the submitted inspection details as required.

    ![Review submitted inspection.](media/inspection/review-submitted-inspection.png?raw=true "Review submitted inspection")
...
1. Select **Inspection insights** tab inside the app.
    ...
    ![Inspection insights.](media/inspection/inspection-insights.png?raw=true "Inspection insights")
...
![Home screen with Planner.](media/inspection/home-screen-with-planner.png?raw=true "Home screen with Planner")
...
![Home screen without Planner.](media/inspection/home-screen-without-planner.png?raw=true "Home screen without Planner")
...
![Inspect a location.](media/inspection/inspect-location.png?raw=true "Inspect a location")
...
![Select an inspection form.](media/inspection/select-inspection-form.png?raw=true "Select an inspection form")
...
![Inspection overview.](media/inspection/inspection-overview.png?raw=true "Inspection overview")
...
![Inspection form.](media/inspection/inspection-form.png?raw=true "Inspection form")
...
![Add a Planner task to an inspection step.](media/inspection/add-task-to-inspection.png?raw=true "Add a Planner task to an inspection step")

If the Planner isn't integrated from the manager app, you can't create tasks and the following screen is displayed.

![Planner not integrated.](media/inspection/planner-not-integrated.png?raw=true "Planner not integrated")
...
![Review inspection.](media/inspection/review-inspection.png?raw=true "Review inspection")
