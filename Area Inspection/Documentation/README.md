...
* [Notify a manager on completion of an inspection](notify-manager-inspections.md)
* [Update inspection notification to use an adaptive card](inspection-adaptive-card.md)
