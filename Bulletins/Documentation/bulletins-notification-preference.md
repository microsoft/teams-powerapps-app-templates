...
Watch this video to learn how to customize apps for end user to add notification preferences: https://www.microsoft.com/videoplayer/embed/RWLn9F
...
1. Verify that the flow was created in the environment with the same name as the team in which the app was installed.
    ...
    ![Flow trigger and get category step](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Bulletins/Documentation/media/add-notification-preference-for-bulletins/flow-trigger-and-get-category-step.png "Flow trigger and get category step")

    ![List bulletins by category step](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Bulletins/Documentation/media/add-notification-preference-for-bulletins/list-bulletins-by-category-step.png "List bulletins by category step")
...
1. Add a step under the Teams case as shown below. Ensure to select the team where you would like to receive the notification.
    ...
    ![Send notification by preference flow step](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Bulletins/Documentation/media/add-notification-preference-for-bulletins/flow-step-to-send-notification-by-preference.png "Send notification by preference flow step")

    ![Send email or post message in teams](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Bulletins/Documentation/media/add-notification-preference-for-bulletins/send-email-post-message-flow-step.png "Send email or post message in teams")
...
1. Set the Notification preference to Email for one and Teams for the other.
    ...
    ![Setup notification preference for each bulletin](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Bulletins/Documentation/media/add-notification-preference-for-bulletins/turn-on-notification-and-select-preference.png "Setup notification preference for each bulletin")
...
1. Select **Publish**.
    ...
    ![Email notification screenshot](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Bulletins/Documentation/media/add-notification-preference-for-bulletins/email-notification.png "Email notification screenshot")
...
1. Select **Publish**.
    ...
    ![Teams notification](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/Bulletins/Documentation/media/add-notification-preference-for-bulletins/teams-notification.png "Teams notification")
