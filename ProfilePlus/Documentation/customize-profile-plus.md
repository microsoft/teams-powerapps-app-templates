...
Watch this video to learn how to customize the Profile+ sample app: https://www.microsoft.com/videoplayer/embed/RWLkWM

Before you can customize the app, you must install it. You can get the app by following the [installation guide](../../INSTALLATION.md).
...
1. Enter **Power Apps** in the search field.
    ...
    ![Search for Power Apps.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/ProfilePlus/Documentation/media/customize-profile-plus/store-search.png "Search for Power Apps")

1. Select the Power Apps app from the list to open the app. Power Apps will open in Microsoft Teams.

   ![Select Power Apps app.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/ProfilePlus/Documentation/media/customize-profile-plus/power-apps-icon.png "Select Power Apps app")
...
1. Select **See all** in the **Profile Plus** tile.
    ...
    ![Select Profile Plus app.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/ProfilePlus/Documentation/media/customize-profile-plus/profile-tile.png "Select Profile Plus app")

1. You'll now see all of the apps and tables.

    ![List of apps and tables.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/ProfilePlus/Documentation/media/customize-profile-plus/component-list.png "List of apps and tables")
...
![Profile+ data model.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/ProfilePlus/Documentation/media/customize-profile-plus/data-model.png "Profile+ data model")
...
![Select Profile+ app.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/ProfilePlus/Documentation/media/customize-profile-plus/select-app.png "Select Profile+ app")

Now that Profile+ is open in Power Apps in Microsoft Teams, select the **Tree View**.

![Tree view.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/ProfilePlus/Documentation/media/customize-profile-plus/loading-screen.png "Tree view")
...
- On the next screen, confirm the channel you want the app to appear. You can add to other channels in the Team by selecting the **+** button. <br>
    ...
    ![Add to channel.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/ProfilePlus/Documentation/media/customize-profile-plus/add-to-channel.png "Add to channel")
...
- Where are my table customizations? <br>
    ...
    ![Built by this team.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/ProfilePlus/Documentation/media/customize-profile-plus/built-by-this-team.png "Built by this team")
...
- Changes made to an app will be added as a new version of the app. If you get a new version from store, your customizations won't be overridden. You'll get a new version that has the latest features, but the new version won't be published. <br>
    ...
    ![Installing new version.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/ProfilePlus/Documentation/media/customize-profile-plus/profile-install.png "Installing new version")
...
the app and allow you to publish the new version. <br>
    ...
    ![Select details.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/ProfilePlus/Documentation/media/customize-profile-plus/app-details.png "Select details")
