...
1. Select **Continue**.
    ...
    ![Select channel and tasks.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/select-channel-tasks.png "Select channel and tasks")
...
1. Select **Let's go**.
    ...
    ![Configure the app.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/configure-app.png "Configure the app")
...
1. Select **Settings**.
    ...
    ![Insights settings.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/insights-settings.png "Insights settings")

1. Make the required changes.

1. Select **Save**.

    ![Save changes.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/save-changes.png "Save changes")
...
1. Select **Save**.
    ...
    ![New issue category.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/new-issue-category.png "New issue category")
...
1. Select **Save**.
    ...
    ![Update category icon.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/update-category-icon.png "Update category icon")
...
1. Rename the category.
    ...
    ![Rename the category in Tasks.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/rename-category-tasks.png "Rename the category in Tasks")
...
1. Select **Delete**.
    ...
    ![Delete a category.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/delete-category.png "Delete a category")
...
1. Select **Add issue template**.
    ...
    ![Add issue template.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/add-issue-template.png "Add issue template")
...
1. Enter the details:
    ...
    ![Enter issue template details.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/issue-template-details.png "Enter issue template details")
...
1. Select **Edit** for the required issue template.
    ...
    ![Edit issue template.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/edit-issue-template.png "Edit issue template")

1. Edit the issue template as required.

1. Select **Save**.

    ![Save issue template changes.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/save-issue-template-changes.png "Save issue template changes")
...
1. Select **Delete**.
    ...
    ![Delete an issue template.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/delete-issue-template.png "Delete an issue template")
...
1. Select the **Insights** tab.
    ...
    ![Review a issue report.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/review-issue-report.png "Review a issue report")
...
1. Select **View Issues**.
    ...
    ![View issues.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/view-issues.png "View issues")
...
1. Select **Submit issue**.
    ...
    ![Submit a new issue.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/submit-new-issue.png "Submit a new issue")
...
1. Edit the task.
    ...
    ![Review and edit a task in Planner.](https://github.com/microsoft/teams-powerapps-app-templates/blob/main/IssueReporting/Documentation/media/issue-reporting/review-edit-task-planner.png "Review and edit a task in Planner")
